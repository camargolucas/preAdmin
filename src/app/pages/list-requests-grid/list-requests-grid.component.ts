...
export class ListRequestsGridComponent implements OnInit {
  ...
  getEconomicGroupById(id:any){
    ...
    let d = data.filter(function(item){
        return item.idGrupoEconomico==id;         
    });
